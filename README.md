...
<img src="https://raw.githubusercontent.com/DavidValin/otp/master/diagram.png"  alt="One Time Pad" />
...
#### How to use it
* Create a key file: `echo "mysupersecretkey" > key.txt`
* Encrypt using key: `echo "hello" | otp key.txt > cipher.txt`
